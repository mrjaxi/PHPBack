<div class="col-md-9">
    ...
    <div class="breadcrumb-wrapper"><ol class="breadcrumb">
            ...
            <li class="active"><?php echo $typetable->name; ?></li>
        </ol></div>
    <div>
    ...
    <table id="ideastable" class="table table-condensed">
        <thead>
        <tr>
            <th><small><?php echo $lang['label_idea']; ?> <a id="order-by--idea" href="<?= $typetable->url .'/title/'; echo ($typetable == 'desc') ? 'asc' : 'desc';?>"><span class="glyphicon glyphicon-chevron-<?php echo ($typetable == 'desc') ? 'down' : 'up'; ?>" style="margin-left:4px"></span></a></small></th>
            <th><small><?php echo $lang['label_votes']; ?> <a id="order-by--votes" href="<?= $typetable->url .'/votes/'; echo ($typetable == 'desc') ? 'asc' : 'desc';?>"><span class="glyphicon glyphicon-chevron-<?php echo ($typetable == 'desc') ? 'down' : 'up'; ?>" style="margin-left:4px"></span></a></small></th>
            <th><small><?php echo $lang['label_comments']; ?></small></th>
            <th><small><?php echo $lang['label_date']; ?> <a id="order-by--date" href="<?= $typetable->url .'/id/'; echo ($typetable == 'desc') ? 'asc' : 'desc';?>"><span class="glyphicon glyphicon-chevron-<?php echo ($typetable == 'desc') ? 'down' : 'up'; ?>" style="margin-left:4px"></span></a></small></th>
        </tr>
        </thead>
    </table>
    ...
    <?php endforeach; ?>
    <ul class="pagination">
        <li><a class="pagination--previous" href="<?php if($page > 1) echo $typetable->url . "/$order/$typetable/" . ($page-1); else echo '#'; ?>">&laquo;</a></li>
        <?php for($i=1;$i<=$pages;$i++){ ?>
            <?php if($i == $page): ?>
                <li class="active"><a class="pagination--current" href=""><?php echo $i;?></a></li>
            <?php else:?>
                <li><a class="pagination--page" href='<?php echo $typetable->url . "/$order/$typetable/$i"; ?>'><?php echo $i;?></a></li>
            <?php endif;?>

        <?php } ?>
        <li><a class="pagination--next" href="<?php  if($page < $pages) echo $typetable->url . "/$order/$typetable/" . ($page+1); else echo '#'; ?>">&raquo;</a></li>
    </ul>
</div>
