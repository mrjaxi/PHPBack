...
<div class="col-md-9">
    ...
    <h5><?php echo $user->name; ?><?php if($user->isadmin): ?><span class="label label-danger" style="margin-left:7px; border-radius: 35px">Админ</span> <?php endif; ?></h5>
                ...
                <table id="resetvotestable" class="table table-striped">
                    ...
                    <?php foreach($votes as $vote): ?>
                        <tr>
                            ...
                            <td><?= $vote['number']; ?></td>
                            <td><a href="<?= base_url() . 'action/unvote/' . $vote['id'];?>"><button type="submit" class="btn btn-warning btn-sm" style="width:130px; border-radius: 35px"><?php echo $lang['label_delete_votes']; ?></button></a></td>
                        </tr>
                    <?php endforeach; ?>
                    </tbody>
                </table>
            ...
            <table id="ideastable" class="table table-condensed">
                ...
                <?php foreach ($ideas as $idea): ?>
                    ...
                    ?>">
                        ...
                        <td>
                            <?= num_word($idea->comments, array('Комментарий', 'Комментария', 'Комментариев'));?>
                        </td>
                        <td>
